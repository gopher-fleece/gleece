...
var _ = Describe("Sanity Controller", func() {
	...
	It("Produces correct method level metadata", func() {
		...
		Expect(route.FuncParams[0].UniqueImportSerial).To(Equal(uint64(2)))
		Expect(route.FuncParams[0].Validator).To(Equal("required"))
		Expect(route.FuncParams[0].Deprecation).To(Equal(definitions.DeprecationOptions{}))
		...
		Expect(route.FuncParams[0].ParamMeta.TypeMeta.Import).To(Equal(common.ImportTypeNone))
		...
		Expect(route.FuncParams[0].ParamMeta.TypeMeta.SymbolKind).To(Equal(common.SymKindBuiltin))
		...
		Expect(route.FuncParams[1].UniqueImportSerial).To(Equal(uint64(3)))
		Expect(route.FuncParams[1].Validator).To(Equal("required"))
		Expect(route.FuncParams[1].Deprecation).To(Equal(definitions.DeprecationOptions{}))
		...
		Expect(route.FuncParams[1].ParamMeta.TypeMeta.Import).To(Equal(common.ImportTypeNone))
		...
		Expect(route.FuncParams[1].ParamMeta.TypeMeta.SymbolKind).To(Equal(common.SymKindBuiltin))
		...
		Expect(route.FuncParams[2].UniqueImportSerial).To(Equal(uint64(4)))
		Expect(route.FuncParams[2].Validator).To(Equal("required"))
		Expect(route.FuncParams[2].Deprecation).To(Equal(definitions.DeprecationOptions{}))
		...
		Expect(route.FuncParams[2].ParamMeta.TypeMeta.Import).To(Equal(common.ImportTypeNone))
		...
		Expect(route.FuncParams[2].ParamMeta.TypeMeta.SymbolKind).To(Equal(common.SymKindBuiltin))
		...
		Expect(route.Responses[1].UniqueImportSerial).To(Equal(uint64(1)))
