...
const (
	DiagAnnotationUnknown                      DiagnosticCode = "annotation-unknown"
	DiagAnnotationInvalidInContext             DiagnosticCode = "annotation-invalid-in-context"
	DiagAnnotationDuplicate                    DiagnosticCode = "annotation-duplicate"
	DiagAnnotationDuplicateValue               DiagnosticCode = "annotation-duplicate-value"
	DiagAnnotationMutuallyExclusive            DiagnosticCode = "annotation-mutually-exclusive"
	...
	DiagAnnotationPropertyShouldNotExist       DiagnosticCode = "annotation-property-should-not-exist"
	...
	DiagLinkerDuplicatePathParam               DiagnosticCode = "linker-duplicate-path-param"
