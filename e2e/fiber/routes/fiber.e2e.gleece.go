...
func RegisterRoutes(engine *fiber.App) {
	...
	engine.Post(toFiberUrl("/e2e/external-packages-unique-in-struct"), func(ctx *fiber.Ctx) error {
		ctx.Set("x-RouteStartRoutesExtension", "ExternalPackagesUniqueInStruct")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			return handleAuthorizationError(ctx, authErr, "ExternalPackagesUniqueInStruct")
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		var conversionErr error
		...
		if conversionErr != nil {
			...
			ctx.Set("x-JsonBodyValidationErrorResponseExtension", "ExternalPackagesUniqueInStruct")
			return ctx.Status(http.StatusUnprocessableEntity).JSON(validationError)
		}
		// Middlewares beforeOperationMiddlewares section
		for _, middleware := range beforeOperationMiddlewares {
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Set("x-BeforeOperationRoutesExtension", "ExternalPackagesUniqueInStruct")
		value, opError := controller.ExternalPackagesUniqueInStruct(*dataRawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Set(key, value)
		}
		ctx.Set("x-inject", "true")
		ctx.Set("x-ResponseHeadersExtension", "ExternalPackagesUniqueInStruct")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Set("x-JsonErrorResponseExtension", "ExternalPackagesUniqueInStruct")
			return ctx.Status(statusCode).JSON(stdError)
		}
		ctx.Set("x-JsonResponseExtension", "ExternalPackagesUniqueInStruct")
		// Middlewares afterOperationSuccessMiddlewares section
		for _, middleware := range afterOperationSuccessMiddlewares {
			if continueOperation := middleware(ctx); !continueOperation {
				return nil
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Set("x-AfterOperationRoutesExtension", "ExternalPackagesUniqueInStruct")
		ctx.Status(statusCode).JSON(value)
		ctx.Set("x-RouteEndRoutesExtension", "ExternalPackagesUniqueInStruct")
		return nil
	})
	...
	engine.Post(toFiberUrl("/e2e/embedded-structs"), func(ctx *fiber.Ctx) error {
		ctx.Set("x-RouteStartRoutesExtension", "EmbeddedStructs")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if conversionErr != nil {
			...
			ctx.Set("x-JsonBodyValidationErrorResponseExtension", "EmbeddedStructs")
			return ctx.Status(http.StatusUnprocessableEntity).JSON(validationError)
		}
		// Middlewares beforeOperationMiddlewares section
		for _, middleware := range beforeOperationMiddlewares {
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Set("x-BeforeOperationRoutesExtension", "EmbeddedStructs")
		value, opError := controller.EmbeddedStructs(*dataRawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Set(key, value)
		}
		ctx.Set("x-inject", "true")
		ctx.Set("x-ResponseHeadersExtension", "EmbeddedStructs")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Set("x-JsonErrorResponseExtension", "EmbeddedStructs")
			return ctx.Status(statusCode).JSON(stdError)
		}
		ctx.Set("x-JsonResponseExtension", "EmbeddedStructs")
		var outputValidationErr error
		outputValidationErr = validateDataRecursive(value, "")
		if outputValidationErr != nil {
			// Middlewares onOutputValidationMiddlewares section
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Set("x-AfterOperationRoutesExtension", "EmbeddedStructs")
		ctx.Status(statusCode).JSON(value)
		ctx.Set("x-RouteEndRoutesExtension", "EmbeddedStructs")
		return nil
	})
