...
func RegisterRoutes(engine *mux.Router) {
	...
	engine.HandleFunc(toMuxUrl("/e2e/primitive-return-type"), func(w http.ResponseWriter, ctx *http.Request) {
		// route start routes extension placeholder
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
	...
	engine.HandleFunc(toMuxUrl("/e2e/primitive-array-return-type"), func(w http.ResponseWriter, ctx *http.Request) {
		// route start routes extension placeholder
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
	...
	engine.HandleFunc(toMuxUrl("/e2e/primitive-alias-return-type"), func(w http.ResponseWriter, ctx *http.Request) {
		// route start routes extension placeholder
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
	...
	engine.HandleFunc(toMuxUrl("/e2e/primitive-alias-array-return-type"), func(w http.ResponseWriter, ctx *http.Request) {
		// route start routes extension placeholder
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
	...
	engine.HandleFunc(toMuxUrl("/e2e/external-packages-unique-in-struct"), func(w http.ResponseWriter, ctx *http.Request) {
		// route start routes extension placeholder
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
	...
	engine.HandleFunc(toMuxUrl("/e2e/embedded-structs"), func(w http.ResponseWriter, ctx *http.Request) {
		// route start routes extension placeholder
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
