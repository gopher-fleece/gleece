...
func RegisterRoutes(engine *gin.Engine) {
	...
	engine.GET(toGinUrl("/e2e/primitive-return-type"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "PrimitiveReturnType")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "PrimitiveReturnType")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "PrimitiveReturnType")
		value, opError := controller.PrimitiveReturnType()
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "PrimitiveReturnType")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "PrimitiveReturnType")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "PrimitiveReturnType")
		// Middlewares afterOperationSuccessMiddlewares section
		for _, middleware := range afterOperationSuccessMiddlewares {
			if continueOperation := middleware(ctx); !continueOperation {
				return
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "PrimitiveReturnType")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "PrimitiveReturnType")
	})
	engine.GET(toGinUrl("/e2e/primitive-array-return-type"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "PrimitiveArrayReturnType")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "PrimitiveArrayReturnType")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "PrimitiveArrayReturnType")
		value, opError := controller.PrimitiveArrayReturnType()
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "PrimitiveArrayReturnType")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "PrimitiveArrayReturnType")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "PrimitiveArrayReturnType")
		// Middlewares afterOperationSuccessMiddlewares section
		for _, middleware := range afterOperationSuccessMiddlewares {
			if continueOperation := middleware(ctx); !continueOperation {
				return
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "PrimitiveArrayReturnType")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "PrimitiveArrayReturnType")
	})
	engine.GET(toGinUrl("/e2e/primitive-alias-return-type"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "PrimitiveAliasReturnType")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "PrimitiveAliasReturnType")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "PrimitiveAliasReturnType")
		value, opError := controller.PrimitiveAliasReturnType()
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "PrimitiveAliasReturnType")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "PrimitiveAliasReturnType")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "PrimitiveAliasReturnType")
		var outputValidationErr error
		outputValidationErr = validateDataRecursive(value, "")
		if outputValidationErr != nil {
			// Middlewares onOutputValidationMiddlewares section
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "PrimitiveAliasReturnType")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "PrimitiveAliasReturnType")
	})
	engine.GET(toGinUrl("/e2e/primitive-alias-array-return-type"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "PrimitiveAliasArrayReturnType")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "PrimitiveAliasArrayReturnType")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "PrimitiveAliasArrayReturnType")
		value, opError := controller.PrimitiveAliasArrayReturnType()
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "PrimitiveAliasArrayReturnType")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "PrimitiveAliasArrayReturnType")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "PrimitiveAliasArrayReturnType")
		var outputValidationErr error
		outputValidationErr = validateDataRecursive(value, "")
		if outputValidationErr != nil {
			// Middlewares onOutputValidationMiddlewares section
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "PrimitiveAliasArrayReturnType")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "PrimitiveAliasArrayReturnType")
	})
	...
	engine.POST(toGinUrl("/e2e/test-primitive-conversions"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "TestPrimitiveConversions")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "TestPrimitiveConversions")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		var value1RawPtr *int64 = nil
		value1Raw, isvalue1Exists := ctx.GetQuery("value1")
		if isvalue1Exists {
			...
			if conversionErr != nil {
				...
				ctx.Header("x-ParamsValidationErrorResponseExtension", "TestPrimitiveConversions")
				ctx.JSON(http.StatusUnprocessableEntity, validationError)
				return
			}
		...
		if validatorErr := validatorInstance.Var(value1RawPtr, "required"); validatorErr != nil {
			...
			ctx.Header("x-RunValidatorExtension", "TestPrimitiveConversions")
			ctx.JSON(http.StatusUnprocessableEntity, validationError)
			return
		}
		var value2RawPtr *bool = nil
		value2Raw, isvalue2Exists := ctx.GetQuery("value2")
		if isvalue2Exists {
		...
		value3Raw, isvalue3Exists := ctx.GetQuery("value3")
		if isvalue3Exists {
		...
		value4Raw, isvalue4Exists := ctx.GetQuery("value4")
		if isvalue4Exists {
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "TestPrimitiveConversions")
		value, opError := controller.TestPrimitiveConversions(*value1RawPtr, *value2RawPtr, *value3RawPtr, *value4RawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "TestPrimitiveConversions")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "TestPrimitiveConversions")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "TestPrimitiveConversions")
		// Middlewares afterOperationSuccessMiddlewares section
		for _, middleware := range afterOperationSuccessMiddlewares {
			if continueOperation := middleware(ctx); !continueOperation {
				return
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "TestPrimitiveConversions")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "TestPrimitiveConversions")
	})
	engine.POST(toGinUrl("/e2e/test-enums"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "TestEnums")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "TestEnums")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		if isvalue1Exists {
			...
			default:
				...
				ctx.Header("x-ParamsValidationErrorResponseExtension", "TestEnums")
				ctx.JSON(http.StatusUnprocessableEntity, validationError)
				return
			}
		}
		if validatorErr := validatorInstance.Var(value1RawPtr, "required"); validatorErr != nil {
			...
			ctx.Header("x-RunValidatorExtension", "TestEnums")
			ctx.JSON(http.StatusUnprocessableEntity, validationError)
			return
		}
		...
		if conversionErr != nil {
			...
			ctx.Header("x-JsonBodyValidationErrorResponseExtension", "TestEnums")
			ctx.JSON(http.StatusUnprocessableEntity, validationError)
			return
		}
		// Middlewares beforeOperationMiddlewares section
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "TestEnums")
		value, opError := controller.TestEnums(*value1RawPtr, *value2RawPtr, *value3RawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "TestEnums")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "TestEnums")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "TestEnums")
		var outputValidationErr error
		outputValidationErr = validateDataRecursive(value, "")
		if outputValidationErr != nil {
			// Middlewares onOutputValidationMiddlewares section
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "TestEnums")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "TestEnums")
	})
	engine.POST(toGinUrl("/e2e/test-enums-in-all/{value1}"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "TestEnumsInAll")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "TestEnumsInAll")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		var value1RawPtr *Param105value1.StatusEnumeration = nil
		value1Raw, isvalue1Exists := ctx.Params.Get("value1")
		if isvalue1Exists {
			value1 := value1Raw
			switch value1Raw {
			case "active", "inactive":
			...
			default:
				...
				ctx.Header("x-ParamsValidationErrorResponseExtension", "TestEnumsInAll")
				ctx.JSON(http.StatusUnprocessableEntity, validationError)
				return
			}
		}
		if validatorErr := validatorInstance.Var(value1RawPtr, "required"); validatorErr != nil {
			...
			ctx.Header("x-RunValidatorExtension", "TestEnumsInAll")
			ctx.JSON(http.StatusUnprocessableEntity, validationError)
			return
		}
		var value2RawPtr *Param106value2.NumberEnumeration = nil
		value2Raw := ctx.GetHeader("value2")
		_, isvalue2Exists := ctx.Request.Header[textproto.CanonicalMIMEHeaderKey("value2")]
		if isvalue2Exists {
			value2Uint64, conversionErr := strconv.Atoi(value2Raw)
			if conversionErr != nil {
				// Middlewares onInputValidationMiddlewares section
		...
		value3Raw, isvalue3Exists := ctx.GetPostForm("value3")
		if isvalue3Exists {
			value3 := value3Raw
			switch value3Raw {
			case "active", "inactive":
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "TestEnumsInAll")
		value, opError := controller.TestEnumsInAll(*value1RawPtr, *value2RawPtr, *value3RawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "TestEnumsInAll")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "TestEnumsInAll")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "TestEnumsInAll")
		// Middlewares afterOperationSuccessMiddlewares section
		for _, middleware := range afterOperationSuccessMiddlewares {
			if continueOperation := middleware(ctx); !continueOperation {
				return
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "TestEnumsInAll")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "TestEnumsInAll")
	})
	engine.POST(toGinUrl("/e2e/test-enums-optional"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "TestEnumsOptional")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "TestEnumsOptional")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		var value1RawPtr *Param110value1.StatusEnumeration = nil
		value1Raw := ctx.GetHeader("value1")
		_, isvalue1Exists := ctx.Request.Header[textproto.CanonicalMIMEHeaderKey("value1")]
		if isvalue1Exists {
			value1 := value1Raw
			switch value1Raw {
			case "active", "inactive":
			...
			default:
				...
				ctx.Header("x-ParamsValidationErrorResponseExtension", "TestEnumsOptional")
				ctx.JSON(http.StatusUnprocessableEntity, validationError)
				return
			}
		}
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "TestEnumsOptional")
		value, opError := controller.TestEnumsOptional(value1RawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "TestEnumsOptional")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "TestEnumsOptional")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "TestEnumsOptional")
		// Middlewares afterOperationSuccessMiddlewares section
		for _, middleware := range afterOperationSuccessMiddlewares {
			if continueOperation := middleware(ctx); !continueOperation {
				return
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "TestEnumsOptional")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "TestEnumsOptional")
	})
	engine.POST(toGinUrl("/e2e/external-packages"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "ExternalPackages")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "ExternalPackages")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		unitRaw, isunitExists := ctx.GetQuery("unit")
		if isunitExists {
			unit := unitRaw
			switch unitRaw {
			...
			default:
				...
				ctx.Header("x-ParamsValidationErrorResponseExtension", "ExternalPackages")
				ctx.JSON(http.StatusUnprocessableEntity, validationError)
				return
			}
		}
		...
		if conversionErr != nil {
			...
			ctx.Header("x-JsonBodyValidationErrorResponseExtension", "ExternalPackages")
			ctx.JSON(http.StatusUnprocessableEntity, validationError)
			return
		}
		// Middlewares beforeOperationMiddlewares section
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "ExternalPackages")
		value, opError := controller.ExternalPackages(unitRawPtr, *dataRawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "ExternalPackages")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "ExternalPackages")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "ExternalPackages")
		var outputValidationErr error
		outputValidationErr = validateDataRecursive(value, "")
		if outputValidationErr != nil {
			// Middlewares onOutputValidationMiddlewares section
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "ExternalPackages")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "ExternalPackages")
	})
	engine.POST(toGinUrl("/e2e/external-packages-unique-in-struct"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "ExternalPackagesUniqueInStruct")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "ExternalPackagesUniqueInStruct")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		if conversionErr != nil {
			...
			ctx.Header("x-JsonBodyValidationErrorResponseExtension", "ExternalPackagesUniqueInStruct")
			ctx.JSON(http.StatusUnprocessableEntity, validationError)
			return
		}
		// Middlewares beforeOperationMiddlewares section
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "ExternalPackagesUniqueInStruct")
		value, opError := controller.ExternalPackagesUniqueInStruct(*dataRawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "ExternalPackagesUniqueInStruct")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "ExternalPackagesUniqueInStruct")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "ExternalPackagesUniqueInStruct")
		// Middlewares afterOperationSuccessMiddlewares section
		for _, middleware := range afterOperationSuccessMiddlewares {
			if continueOperation := middleware(ctx); !continueOperation {
				return
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "ExternalPackagesUniqueInStruct")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "ExternalPackagesUniqueInStruct")
	})
	engine.POST(toGinUrl("/e2e/external-packages-validation"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "ExternalPackagesValidation")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "ExternalPackagesValidation")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		if isunitExists {
			...
			default:
				...
				ctx.Header("x-ParamsValidationErrorResponseExtension", "ExternalPackagesValidation")
				ctx.JSON(http.StatusUnprocessableEntity, validationError)
				return
			}
		}
		...
		if conversionErr != nil {
			...
			ctx.Header("x-JsonBodyValidationErrorResponseExtension", "ExternalPackagesValidation")
			ctx.JSON(http.StatusUnprocessableEntity, validationError)
			return
		}
		// Middlewares beforeOperationMiddlewares section
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "ExternalPackagesValidation")
		value, opError := controller.ExternalPackagesValidation(unitRawPtr, *dataRawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "ExternalPackagesValidation")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "ExternalPackagesValidation")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "ExternalPackagesValidation")
		var outputValidationErr error
		outputValidationErr = validateDataRecursive(value, "")
		if outputValidationErr != nil {
			// Middlewares onOutputValidationMiddlewares section
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "ExternalPackagesValidation")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "ExternalPackagesValidation")
	})
	engine.POST(toGinUrl("/e2e/arrays-in-body-and-res"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "ArraysInBodyAndRes")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "ArraysInBodyAndRes")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		if conversionErr != nil {
			...
			ctx.Header("x-JsonBodyValidationErrorResponseExtension", "ArraysInBodyAndRes")
			ctx.JSON(http.StatusUnprocessableEntity, validationError)
			return
		}
		// Middlewares beforeOperationMiddlewares section
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "ArraysInBodyAndRes")
		value, opError := controller.ArraysInBodyAndRes(*dataRawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "ArraysInBodyAndRes")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "ArraysInBodyAndRes")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "ArraysInBodyAndRes")
		var outputValidationErr error
		outputValidationErr = validateDataRecursive(value, "")
		if outputValidationErr != nil {
			// Middlewares onOutputValidationMiddlewares section
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "ArraysInBodyAndRes")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "ArraysInBodyAndRes")
	})
	engine.POST(toGinUrl("/e2e/arrays-inside-body-and-res"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "ArraysInsideBodyAndRes")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "ArraysInsideBodyAndRes")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		if conversionErr != nil {
			...
			ctx.Header("x-JsonBodyValidationErrorResponseExtension", "ArraysInsideBodyAndRes")
			ctx.JSON(http.StatusUnprocessableEntity, validationError)
			return
		}
		// Middlewares beforeOperationMiddlewares section
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "ArraysInsideBodyAndRes")
		value, opError := controller.ArraysInsideBodyAndRes(dataRawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "ArraysInsideBodyAndRes")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "ArraysInsideBodyAndRes")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "ArraysInsideBodyAndRes")
		var outputValidationErr error
		if value == nil {
			outputValidationErr = fmt.Errorf("Response payload is nil")
		} else {
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "ArraysInsideBodyAndRes")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "ArraysInsideBodyAndRes")
	})
	engine.POST(toGinUrl("/e2e/deep-arrays-with-validation"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "DeepArraysWithValidation")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "DeepArraysWithValidation")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		if conversionErr != nil {
			...
			ctx.Header("x-JsonBodyValidationErrorResponseExtension", "DeepArraysWithValidation")
			ctx.JSON(http.StatusUnprocessableEntity, validationError)
			return
		}
		// Middlewares beforeOperationMiddlewares section
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "DeepArraysWithValidation")
		value, opError := controller.DeepArraysWithValidation(*dataRawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "DeepArraysWithValidation")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "DeepArraysWithValidation")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "DeepArraysWithValidation")
		var outputValidationErr error
		outputValidationErr = validateDataRecursive(value, "")
		if outputValidationErr != nil {
			// Middlewares onOutputValidationMiddlewares section
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "DeepArraysWithValidation")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "DeepArraysWithValidation")
	})
	engine.POST(toGinUrl("/e2e/embedded-structs"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "EmbeddedStructs")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "EmbeddedStructs")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		if conversionErr != nil {
			...
			ctx.Header("x-JsonBodyValidationErrorResponseExtension", "EmbeddedStructs")
			ctx.JSON(http.StatusUnprocessableEntity, validationError)
			return
		}
		// Middlewares beforeOperationMiddlewares section
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "EmbeddedStructs")
		value, opError := controller.EmbeddedStructs(*dataRawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "EmbeddedStructs")
		statusCode := getStatusCode(&controller, true, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "EmbeddedStructs")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "EmbeddedStructs")
		var outputValidationErr error
		outputValidationErr = validateDataRecursive(value, "")
		if outputValidationErr != nil {
			// Middlewares onOutputValidationMiddlewares section
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "EmbeddedStructs")
		ctx.JSON(statusCode, value)
		ctx.Header("x-RouteEndRoutesExtension", "EmbeddedStructs")
	})
	engine.POST(toGinUrl("/e2e/context-injection-empty"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "ContextInjectionEmpty")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "ContextInjectionEmpty")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "ContextInjectionEmpty")
		opError := controller.ContextInjectionEmpty(ctx.Request.Context())
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "ContextInjectionEmpty")
		statusCode := getStatusCode(&controller, false, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "ContextInjectionEmpty")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "ContextInjectionEmpty")
		// Middlewares afterOperationSuccessMiddlewares section
		for _, middleware := range afterOperationSuccessMiddlewares {
			if continueOperation := middleware(ctx); !continueOperation {
				return
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "ContextInjectionEmpty")
		ctx.Status(statusCode)
		ctx.Header("x-RouteEndRoutesExtension", "ContextInjectionEmpty")
	})
	engine.POST(toGinUrl("/e2e/context-injection"), func(ctx *gin.Context) {
		ctx.Header("x-RouteStartRoutesExtension", "ContextInjection")
		authErr := authorize(
			ctx,
			[]SecurityCheckList{
				{
		...
		if authErr != nil {
			handleAuthorizationError(ctx, authErr, "ContextInjection")
			return
		}
		controller := E2EControllerImport.E2EController{}
		controller.InitController(ctx)
		...
		if conversionErr != nil {
			...
			ctx.Header("x-JsonBodyValidationErrorResponseExtension", "ContextInjection")
			ctx.JSON(http.StatusUnprocessableEntity, validationError)
			return
		}
		// Middlewares beforeOperationMiddlewares section
		...
		// End middlewares beforeOperationMiddlewares section
		ctx.Header("x-BeforeOperationRoutesExtension", "ContextInjection")
		opError := controller.ContextInjection(ctx.Request.Context(), *dataRawPtr)
		for key, value := range controller.GetHeaders() {
			ctx.Header(key, value)
		}
		ctx.Header("x-inject", "true")
		ctx.Header("x-ResponseHeadersExtension", "ContextInjection")
		statusCode := getStatusCode(&controller, false, opError)
		if opError != nil {
			// Middlewares onErrorMiddlewares section
			for _, middleware := range onErrorMiddlewares {
			...
			ctx.Header("x-JsonErrorResponseExtension", "ContextInjection")
			ctx.JSON(statusCode, stdError)
			return
		}
		ctx.Header("x-JsonResponseExtension", "ContextInjection")
		// Middlewares afterOperationSuccessMiddlewares section
		for _, middleware := range afterOperationSuccessMiddlewares {
			if continueOperation := middleware(ctx); !continueOperation {
				return
		...
		// End middlewares afterOperationSuccessMiddlewares section
		ctx.Header("x-AfterOperationRoutesExtension", "ContextInjection")
		ctx.Status(statusCode)
		ctx.Header("x-RouteEndRoutesExtension", "ContextInjection")
	})
