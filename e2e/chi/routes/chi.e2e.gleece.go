...
func RegisterRoutes(engine *chi.Mux) {
	...
	engine.Post(toChiUrl("/e2e/test-enums"), func(w http.ResponseWriter, ctx *http.Request) {
	...
	engine.Post(toChiUrl("/e2e/test-enums-in-all/{value1}"), func(w http.ResponseWriter, ctx *http.Request) {
		...
		value1Raw := chi.URLParam(ctx, "value1")
	...
	engine.Post(toChiUrl("/e2e/test-enums-optional"), func(w http.ResponseWriter, ctx *http.Request) {
	...
	engine.Post(toChiUrl("/e2e/external-packages"), func(w http.ResponseWriter, ctx *http.Request) {
	...
	engine.Post(toChiUrl("/e2e/external-packages-validation"), func(w http.ResponseWriter, ctx *http.Request) {
	...
	engine.Post(toChiUrl("/e2e/arrays-in-body-and-res"), func(w http.ResponseWriter, ctx *http.Request) {
	...
	engine.Post(toChiUrl("/e2e/arrays-inside-body-and-res"), func(w http.ResponseWriter, ctx *http.Request) {
	...
	engine.Post(toChiUrl("/e2e/deep-arrays-with-validation"), func(w http.ResponseWriter, ctx *http.Request) {
