...
func RegisterRoutes(engine *chi.Mux) {
	...
	engine.Get(toChiUrl("/e2e/primitive-return-type"), func(w http.ResponseWriter, ctx *http.Request) {
	...
	engine.Get(toChiUrl("/e2e/primitive-array-return-type"), func(w http.ResponseWriter, ctx *http.Request) {
	...
	engine.Get(toChiUrl("/e2e/primitive-alias-return-type"), func(w http.ResponseWriter, ctx *http.Request) {
	...
	engine.Get(toChiUrl("/e2e/primitive-alias-array-return-type"), func(w http.ResponseWriter, ctx *http.Request) {
	...
	engine.Post(toChiUrl("/e2e/external-packages-unique-in-struct"), func(w http.ResponseWriter, ctx *http.Request) {
	...
	engine.Post(toChiUrl("/e2e/embedded-structs"), func(w http.ResponseWriter, ctx *http.Request) {
